...
##          get_console_log, get_errors, get_debugger_errors, clear_console_log,
##          open_in_godot, scene_tree_dump, rescan_filesystem,
##          run_scene, stop_scene, is_playing, classdb_query
...
func get_supported_tools() -> PackedStringArray:
	return PackedStringArray([
		...
		"get_debugger_errors", "clear_console_log", "open_in_godot",
...
func process_command(tool_name: String, args: Dictionary) -> Dictionary:
	match tool_name:
		...
		"update_project_settings":
			return update_project_settings(args)
		"get_input_map":
			return get_input_map(args)
		"configure_input_map":
			return configure_input_map(args)
		"get_collision_layers":
			return get_collision_layers(args)
		"get_node_properties":
			return get_node_properties(args)
		"setup_autoload":
			return setup_autoload(args)
		"get_console_log":
			return get_console_log(args)
		"get_errors":
			return get_errors(args)
		"get_debugger_errors":
			return get_debugger_errors(args)
		"clear_console_log":
		...
		"rescan_filesystem":
			return rescan_filesystem(args)
		"run_scene":
			return run_scene(args)
		"stop_scene":
			return stop_scene(args)
		"is_playing":
...
func clear_console_log(_args: Dictionary) -> Dictionary:
	...
	return {&"ok": true, &"message": "Console log cleared."}
...
func classdb_query(args: Dictionary) -> Dictionary:
	...
	if query == "all" or query == "methods":
		...
		for method: Dictionary in ClassDB.class_get_method_list(class_name_str, true):
			...
			methods.append({&"name": method_name, &"args": method_args,
